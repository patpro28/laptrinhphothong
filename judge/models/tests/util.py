...
class CreateProblem(CreateModel):
    ...
    m2m_fields = {
        'authors': (Profile, 'username'),
        'curators': (Profile, 'username'),
        'testers': (Profile, 'username'),
        'types': (ProblemType, 'name'),
        'allowed_languages': (Language, 'key'),
        'banned_users': (Profile, 'username'),
...
class CreateContest(CreateModel):
    ...
    m2m_fields = {
        ...
        'view_contest_scoreboard': (Profile, 'username'),
        'rate_exclude': (Profile, 'username'),
        'private_contestants': (Profile, 'username'),
        'organizations': (Organization, 'name'),
