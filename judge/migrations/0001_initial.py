    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_solution', models.BooleanField(default=False, verbose_name='can add solution')),
                ('limit_solution', models.IntegerField(default=0, verbose_name='limit solution')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_accept', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='judge.contestparticipation', verbose_name='first user accept this problem')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contests', to='judge.problem', verbose_name='problem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mean', models.FloatField(blank=True, null=True, verbose_name='raw rating')),
                ('performance', models.FloatField(blank=True, null=True, verbose_name='contest performance')),
