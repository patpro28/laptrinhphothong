...
from django.forms import BaseModelFormSet, ModelForm, formset_factory
...
class ProblemDataForm(ModelForm):
    io_method = forms.ChoiceField(choices=IO_METHODS, label=_('IO Method'), initial='standard', required=False,
                            widget=Select)
    io_input_file = forms.CharField(max_length=100, label=_('Input from file'), required=False)
    io_output_file = forms.CharField(max_length=100, label=_('Output to file'), required=False)
